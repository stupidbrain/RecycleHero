...
public class BuildManager3 : MonoBehaviour
{
    ...
    {
        if (MoneyCount2.money >= turretPrice && !startBuild)
        {
            startBuild = true;
